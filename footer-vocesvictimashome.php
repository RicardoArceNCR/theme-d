...
<script>
  ...
  $('#videos-victimas').on('show.bs.modal', function (event) {
    var button = $(event.relatedTarget);
    var modal = $(this);
    let video_url = button.data('video');
    open_video = true;
    mySwiper.autoplay.stop()
    change_video(video_url);
  })
  $('#videos-victimas').on('hidden.bs.modal', function (event) {
    open_video = false;
...
mySwiper.on('slideChange', function () {
  let video_url = $(mySwiper.slides[mySwiper.activeIndex]).find("a").data('video');
...
$('#back-swiper-slide').on('click', function(){
  mySwiper.slidePrev();
})
$('#next-swiper-slide').on('click', function(){
  mySwiper.slideNext();
})
</script>
<script>
