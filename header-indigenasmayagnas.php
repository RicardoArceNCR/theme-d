...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Text&family=Trocchi&display=swap" rel="stylesheet">-
    <!-- FontAwesome -->
...
<body <?php body_class(); ?>>
    <?php wp_body_open(); ?>
    <header class="bg-header-movil fixed-top">
        <div class="container">
            <div class="row flex-nowrap justify-content-between align-items-center py-4 nav-top">
                <div class="col-sm-3 col-md-4 pt-1 social-i"><link rel="preconnect" href="https://fonts.googleapis.com">
                    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                    <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Text&family=Trocchi&display=swap" rel="stylesheet">
