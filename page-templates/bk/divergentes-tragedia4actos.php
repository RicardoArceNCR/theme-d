...
<section class="tragedia-4actos contenido mt-5 text-justify">
    ...
    <div class="container">
        <div class="row pt-3">
            <div class="col-md-1"></div>
            <div class="col-md-10">
                <p>Nicaragua, sin embargo, ha cumplido más de dos años de crisis. Las protestas que se han extendido en todo el país comenzaron como repudio a la reforma impuesta por Ortega para “rescatar” de la quiebra al Instituto Nicaragüense de Seguridad Social (INSS). Esas reformas, aprobadas por decreto y publicadas en el diario oficial del Estado sin consenso con las cúpulas empresariales, representaban un duro golpe para jubilados, empleados y empresas, principalmente las más pequeñas. Entre las medidas se incluía una reducción del 5% a las pensiones —ya de por sí muy menguadas— que reciben cientos de miles de jubilados, para que con ello financien su atención médica. Además aumentaba del 19% al 22.5% la cuota que las empresas deben entregar al Seguro, lo que para el economista Adolfo Acevedo hubiera obligado a los empresarios a buscar mecanismos para reducir la afiliación de trabajadores al sistema de Seguridad Social, reducir personal y, en el caso de las empresas pequeñas, echar el cierre. Los trabajadores también debían aumentar sus aportes, reduciendo el valor de sus salarios. El salario mínimo promedio en Nicaragua es de 150 dólares.</p>
                <p>Ortega desató una brutal represión contra los manifestantes, que ha dejado más de 328 muertos, según el recuento oficial de la Comisión Interamericana de Derechos Humanos (CIDH). Hay más de 2000 heridos y centenares de presos. Además, se han perdido casi medio millón de empleos y más de 80 000 nicaragüenses han dejado el país huyendo de la violencia.
                </p>

                <p>El mandatario acusó a los manifestantes de querer perpetrar un golpe de Estado en su contra, pero ha sido su esposa —en un acto de desesperación— quien ha atacado con dureza en los medios de comunicación a los manifestantes, catalogándolos de “minúsculos”, “vandálicos”, “plagas”, “delincuentes”, “vampiros”, “terroristas”, “golpistas” y “diabólicos”. “¡No pasarán! los diabólicos no podrán nunca gobernar Nicaragua”, dijo Murillo el 16 de julio de 2018. Un fin de semana de finales de septiembre una Murillo descompuesta, los ojos encendidos y la voz pastosa, espetó a la cámara: “¡¿De qué se quejan, de qué se quejan!?” Por esos epítetos en Nicaragua los manifestantes la han bautizado como “Lady Minúscula”, en referencia a la Lady Macbeth de Shakespeare.</p>

                <p>Ortega y su mujer intentan encajar el golpe, pero en Nicaragua hay un antes y un después para el régimen. Ella, que según sus críticos soñaba con convertirse en la presidenta de Nicaragua instaurando una nueva dinastía familiar, ve cómo esos “terroristas” reventaron sus planes. Encerrada junto a Ortega en su búnker de Managua bajo un sistema de seguridad enorme que incluye el cierre de calles a varios kilómetros de la residencia presidencial localizada en reparto El Carmen, la mujer del Comandante, Rosario Murillo, como una Lady Macbeth del trópico, ve cómo su propio bosque de Birnam, de puro metal, se mueve, en un preludio del fin de su sueño de poder.</p>
            </div>
        </div>
    </div>
    </div>
    <div class="manchas_publicidad mt-5"></div>
    <div class="container mt-5">
        <div class="row pt-3">
            <div class="col-md-1"></div>
            <div class="col-md-10">
                <h1 class="my-5">Epílogo</h1>
                <p>Dejé Nicaragua en diciembre de 2018. Las huestes de Ortega me habían acosado, primero, luego atacado y por último vigilaban todos mis movimientos, mi casa, me seguían hombres armados allá donde me movía y una noche me alertaron de que podrían apresarme. Desde entonces he contemplado desde la distancia —desde el difícil exilio en un país extraño, en una enorme ciudad que considero hermosa pero hostil y que me ha abrazado y me ha dado protección— cómo la situación de mi país, del que me siento orgulloso, se ha deterioro por la locura de poder de Ortega y su mujer. El penúltimo acto de esta tragedia infame es el negligente manejo de la pandemia de coronavirus, el bicho que ha matado a decenas de miles de personas en el mundo y nos ha trastocado la vida. La primera reacción del régimen fue negar su letalidad, pero terminó aceptándola ante lo innegable: la vulnerabilidad de Nicaragua, de su precario sistema sanitario y de su situación geográfica, territorio de paso en Centroamérica. Las cifras oficiales son un chiste, pero si nos atenemos a ellas, al menos 64 nicaragüenses han muerto y 1 823 están contagiados. Mis colegas periodistas cuentan otra historia, aterradora: morgues repletas de cadáveres, UCI sin camas disponibles, gente enterrada en la clandestinidad, para no aceptar que murieron de covid-19, médicos pidiendo a gritos medidas de contingencia. Murillo miente, miente, miente, presa de su propia cárcel: la ambición de poder. La mujer del Comandante, sin escapatoria al firme juicio que hará de ella la historia, sabe que no tiene otra forma de mantenerse en su delirio que retorcer el cuello de un país desangrado. El último acto de esta tragedia está por escribirse.</p>
                <p><i>Este perfil fue publicado originalmente en la revista Contrapoder. El autor actualizó el texto para esta publicación.</i></p>
            </div>
        </div>
    </div>
    <div class="container creditos my-5">
        <div class="row">
            <div class="col">
                <h1>CRÉDITOS</h1>
                Texto: Carlos Salinas Maldonado
<br>Fotografía: Oscar Navarrete y Carlos Herrera
<br>Ilustración de portada: Lonnie Ruiz 
