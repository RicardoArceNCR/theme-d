...
/*
* Template Name: nunca-callar-activismo-destierro-eng
...
?>
        ...
        <div class="row">
            <div class="col text-center scd-intro">
                <img id="animatedElement" src="https://www.divergentes.com/wp-content/uploads/2024/02/js_10.jpg"
                     class="img-fluid"
                     alt="tunel">
                <a href="<?php echo esc_url( get_permalink(43003) ); ?>" title="" class="btn scd-btn2 my-4" >
                ...
                <h1 class="text-center">Never remain silent:</h1>
                <h2>activism in the midst of exile</h2>
                <p>
                ...
                <p class="scd-intro-creditos">
                    By Franklin Villavicencio <a href="https://twitter.com/fvillabravo">(@fvillabravo)</a>
                </p>
    ...
    <div class="container scd-contenido">
        <div class="row">
            <div class="col">
                <p>Evelyn Pinto no longer uses social media as she used to, but spends most of her time very active in a WhatsApp group special to her. It is the only one she usually frequents, because after being banished by the Ortega-Murillo dictatorship on February 9, she decided to stay away from digital spaces to "take care" of her mental health. It is not surprising.&nbsp;</p>
                <p>One of the crimes for which the Sandinista regime sentenced her was -allegedly- spreading fake news. "They practically pretended I was an influencer with thousands of followers, when I only had about 300 followers on Twitter," she recalls, via phone call from Texas.&nbsp;</p>
                <p>Pinto is a historic activist who throughout her life has been involved in social fights. An experienced advocate for the rights of children and teenagers in organizations such as Fe y Alegr&iacute;a, she has also defended the causes of women and indigenous peoples. And of course, when the April 2018 protests started, she was one of the tens of thousands of Nicaraguans who took to the streets and participated in the self-convened demonstrations.&nbsp;</p>
                <p>As a result, the dictatorship captured her on November 6, 2021, on the eve of Nicaragua's presidential elections, in which Ortega and Murillo had no political competition due to the imprisonment of the main opposition leaders. Since June of that same year, the dictators unleashed an unprecedented hunt, practically imprisoning and disqualifying all opposition options that sought to compete against them.</p>
                <p>After her capture and subsequent stay in women's prison La Esperanza, Pinto suffered several health relapses. The heat of Managua, coupled with her hypertension, affected her so much that her relatives feared her life was at risk.</p>
                <p>By March 2022, the regime accused her of spreading fake news and treason, two of the most common political crimes used by the dictatorship against critics of its regime.&nbsp;</p>
                <p>She was sentenced to eight years in prison and disqualified from holding public office. On February 9, 2023, the dictatorship banished her and 221 other political prisoners. They were sent on a one-way trip to the United States, the country that welcomed her in one of the most delicate diplomatic operations in recent times.&nbsp;</p>
                <p>Exile changed her life. Especially when she learned that it would be in a nation so different from her own. "It all led me to feeling a lot of tension, worry, and anxiety about what was going to happen. What was going to happen to my house, to all my things? In terms of activism, I frankly didn't have the opportunity to continue with it for several months. I said to myself: I can't do it right now, I need the time for myself, to stabilize, to heal a little bit", Pinto assures, with enough distance from those first months.</p>
            </div>
        </div>
    </div>
    ...
    <div class="scd-parallax-container">
        ...
        <div class="scd-text-content">
            <div class="container scd-contenido">
                <div class="row">
                    <div class="col">
                        <h2>Getting everything back</h2>
                        <p>Being exiled not only meant a new life, but also entering a reality she barely understood. The world, and its correlation with the Ortega-Murillo regime, had changed. Many entered prison when small signs of rebellion against the dictatorship were possible in Nicaragua. They came out when no one in the country could speak out against Daniel Ortega and Rosario Murillo.&nbsp;</p>
                        <p>The way to do activism had to change. This is what Tamara Davila, member of the Nicaraguan Democratic Union (Unamos) and part of the group of the 222 exiled, thinks.</p>
                        <p>"The main challenge for me has to do with making the different States and public officials understand that there should be no competition between the humanitarian and human rights conflicts that are taking place in the world, that everything should be prioritized," remarks D&aacute;vila, who has slowly resumed her activism.</p>
                        <p>D&aacute;vila still belongs to Unamos and has recently joined Monteverde, a political project that includes various opposition actors and movements. "My actions have been focused on lobbying and meetings to keep Nicaragua on the political agenda of the United States, but also of other countries in Europe," she adds.</p>
                        <p>But getting to this point meant a whole process for D&aacute;vila, due to the adaptation it meant to get out of prison. For her, coming out of captivity meant learning again to adapt to the noises outside, the light, the food, and freedom.&nbsp;</p>
                        <p>"The goal and part of our activism is to be healthy, and for me the mental health support that I continue to receive has been fundamental," says D&aacute;vila, whose after-effects of prison have been treated through therapy.&nbsp;</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container scd-contenido py-5">
        <div class="row">
            <div class="col">
                ...
                <h2>Digital activism<br>in the face of repression</h2>
                <p>
                <p>Evelyn Pinto found a job that brings her closer to her fights. In the county where she lives she teaches Latino parents about democracy. "It's important because from our countries we bring all the culture of the house we were raised in and this is a very nice program they have in the county," she says.</p>
                <p>Working on these issues reminds her of the activism she did in previous years, which was also related to defending human rights and building a democratic culture.&nbsp;</p>
                <p>But, what most links her to what she did before is the WhatsApp group she shares with other exiled Nicaraguan women in which they organize actions to remind the world that there are still 91 political prisoners in Nicaragua.</p>
                <p>"The fact of not being able to go out and say anything, of not being able to do anything, of being here immobile, is emotionally affecting me, it makes me feel bad. Little by little, I began to prioritize and define the areas and people I wanted to work on activism with. Through the women's group, we decided to make videos to denounce and demand freedom for women prisoners. At that time, Olesia (Mu&ntilde;oz) and a group of women prisoners in La Esperanza were on hunger strike. So we made a video for them," recalls Evelyn.</p>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="scd-parallax-container">
        ...
        <div class="scd-text-content">
            <div class="container scd-contenido">
                <div class="row">
                    <div class="col">
                        <h2>Healing in exile</h2>
                        <p>
                        <p>Ana Margarita Vijil has had to rethink her activism in this new context. Although in Nicaragua, before being imprisoned, she had to work in clandestinity, always hidden from the regime, she felt she had more freedom to help other people.&nbsp;</p>
                        <p>"Being exiled has forced me out of my habitat, I had to rethink how I could continue doing those two things in an environment I didn't know, having to, in fact, look for another way to survive, because, well, they took everything away from us," she says via phone call from a cold northern U.S. city, which she prefers not to mention.&nbsp;</p>
                        <p>"So, it has been a great personal challenge, but I feel that at the same time activism, the connection with this greater cause which is to change what is wrong in Nicaragua, is also what has helped me to cope," she adds.</p>
                        <p>Her activism, like that of most people in exile, consists of keeping in touch with the rest of the exiles and creating solidarity networks. The situation, for many, is critical. Unemployment, the high cost of living and a very different culture have affected the lives of many.&nbsp;</p>
                        <p>In fact, the Nicaraguan diaspora in the United States took care of everything related to housing for most of the 222 political prisoners exiled by the dictatorship.&nbsp;</p>
                        <p>"What we did was that a group of people and organizations of the diaspora opened the doors of their homes, for a period of three months. It is very difficult, because the diaspora was not emotionally prepared to receive them," assures Damaris Rostr&aacute;n, a Nicaraguan activist based in the United States since 2022, who dedicated herself to coordinating solidarity networks for the political exiles.</p>
                        <p>"Sometimes we feel that it is too much, that the situation will never end, and then I think that we are closer, we are closer to the end, we have already made a lot of progress," reflects Ana Margarita.</p>
                        </p>
                    </div>
                </div>
            </div>
