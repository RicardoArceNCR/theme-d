...
/*
* Template Name: divergentes-home2
*
* @package WordPress
*/
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card-body px-0">
                                            <span class="titulo-seccion"><?php echo (!empty(get_the_category()) && isset(get_the_category()[0]) ? get_the_category()[0]->cat_name : ''); ?></span>
                                            <a href="<?php the_permalink(); ?>" title="<?php divergentes_post_title(); ?>">
...
<!--                            <a href="https://cdnicaraguense.org/cada-vida-cuenta-una-historia/" id="banner-cdnicaraguense" title="Cada vida cuenta una historia" target="_blank" style="
    position: relative;
    display: block;
    margin-top: 15px !important;!i;!;
">
                                <span style="position:absolute;top: -19px;left: 0;padding: 2px;font-weight: 300;color: white;background: #9c9c9c;font-size: 10px;border-radius: 0px 5px 0px 0px;">PUBLICIDAD</span>
                                <img src="https://www.divergentes.com/wp-content/uploads/2024/11/Divergentes-Banner-CDN-448x790-1.png" class="img-fluid" alt="Cada vida cuenta una historia">
                            </a>
                            <script>
                                let banner = document.querySelector("#banner-cdnicaraguense");
                                        ...
                                        entries.forEach(entry => {
                                            if (entry.isIntersecting) {
                                                gtag('event', 'banner_impression', {
                                                    content_type: 'banner',
                                                    banner_name: 'banner-cdnicaraguense',
                                                    banner_position: 'home' // Puedes agregar más parámetros personalizados
                                                });
                                                observer.unobserve(banner); // Para evitar enviar múltiples impresiones
                                            }
                                        });
                                    });
                                    observer.observe(banner);
                                }
                                document.querySelector("#banner-cdnicaraguense").addEventListener('click', function() {
                                    gtag('event', 'banner_click', {
                                        content_type: 'banner',
                                        banner_name: 'banner-cdnicaraguense',
                                        banner_position: 'home', // Igual que en las impresiones
                                        url_destino: this.href // Opcional: capturar la URL de destino
                                    });
                                });
                                ...
                                <div class="card portada_laterales top-home-padding">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-md-12">
                                            <div class="card-body px-0">
                                                <span class="titulo-seccion"><?php 
                                                    $categories = get_the_category();
                                                    echo !empty($categories) && isset($categories[0]) ? $categories[0]->cat_name : '';
                                                ?></span>
                                                <a href="<?php the_permalink(); ?>">
...
<!--                            <a href="https://cdnicaraguense.org/cada-vida-cuenta-una-historia/"
                               id="banner-cdnicaraguense" title="Cada vida cuenta una historia" target="_blank" style="
    position: relative;
    display: block;
    margin-top: 15px !important;!i;!;
">
                                <span style="position:absolute;top: -19px;left: 0;padding: 2px;font-weight: 300;color: white;background: #9c9c9c;font-size: 10px;border-radius: 0px 5px 0px 0px;">PUBLICIDAD</span>
                                <img src="https://www.divergentes.com/wp-content/uploads/2024/11/Divergentes-Banner-CDN-448x790-1.png"
                                     class="img-fluid" alt="Cada vida cuenta una historia">
                            </a>
                            <script>
                                let banner = document.querySelector("#banner-cdnicaraguense");
