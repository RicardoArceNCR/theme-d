...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="entry-header col-sm-12 col-lg-10 offset-lg-1 mb-2  container">
        <div class="  row">
            <div class="col-12">
                <?php
                if (is_singular()) :
        ...
        <div class="entry-meta   row">
            ...
            <div class="col-lg-2 col-md-3 text-right">
                ...
                <?php echo do_shortcode('[Sassy_Social_Share align="right"]') ?>
            </div>
        ...
        if (in_category('fact-checking')) {
            ...
            if ($tipo_plantilla == 'default' || $tipo_plantilla == '') {
                ...
                if ($term != null):
                    ...
                    ?>
                    <div class="fact-checking mt-2" style="background-color:<?php echo $color; ?> ">
                        <div class="row">
                            <div class="col-6">
                                <img src="<?php echo $image; ?>" class="img-fluid logo-factchecking"/>
                            </div>
                            <div class="col-6 text-right">
                                <img src="https://www.divergentes.com/wp-content/uploads/2021/09/logo-verificadoDV.svg"
                                     class="img-fluid logo-verificado"/>
                            </div>
                        </div>
