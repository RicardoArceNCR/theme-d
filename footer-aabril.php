...
<footer>
    <div class="container">
        <p>©️ TODOS LOS DERECHOS RESERVADOS. MANAGUA, NICARAGUA. ABRIL 2021. Esta publicación puede ser utilizada, total o parcialmente, con previa autorización de la dirección del medio, se deben respetar los créditos de producción y adjuntar un enlace
...
<script>
	...
	$(window).scroll(function() {
		var top_of_element = $("#topelement").offset().top;
		var bottom_of_element = $("#topelement").offset().top + $("#topelement").outerHeight();
