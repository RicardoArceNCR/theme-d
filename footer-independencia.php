...
<footer>
    <div class="container">
        <p>©️ TODOS LOS DERECHOS RESERVADOS. MANAGUA, NICARAGUA. SEPTIEMBRE 2021. Esta publicación puede ser utilizada, total o parcialmente, con previa autorización de la dirección del medio, se deben respetar los créditos de producción y adjuntar un enlace
...
$(function() {
    if (window.innerWidth > 575) {
      ...
      $('.img-fixtoalba').fixTo('.fixto-alba', {
        top: 0
      }
