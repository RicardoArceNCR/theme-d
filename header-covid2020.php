...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<header class="covid-2020 fixed-top">
        <div class="container">
            ...
            <div class="col-sm-3 col-md-4 pt-1 social-i">
                    <a href="<?php echo get_site_url(); ?>" title="Home" class="social-top"><i class="fas fa-home"></i></a>
                    <a href="https://www.facebook.com/DivergentesCA/" title="Facebook" target="_blank" class="social-top"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://twitter.com/DivergentesCA" title="Twitter" target="_blank" class="social-top"><i class="fab fa-twitter"></i></a>
                </div>
                ...
                <div class="col-sm-2 col-md-4 d-flex justify-content-end align-items-center">
                    <!-- <a class="nav-link btn-divergentes ml-2" href="#">SER PARTE</a>
        <a class="nav-link btn-light ml-2" href="#">INICIAR SESIÓN</a>
        <a href="https://twitter.com/DivergentesCA" title="Twitter" target="_blank"><i
