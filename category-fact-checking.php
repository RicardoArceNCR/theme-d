...
?>
    <div class="container sitio-archivo">
        ...
        <div class="row pt-2 pt-md-4 mb-5">
            ...
            <div class="col-md-4 text-center">
                ...
                <img src="https://www.divergentes.com/wp-content/uploads/2022/04/logoDivercheck.svg" alt="DiverCheck Logo" class="img-fluid" width="140" />
            </div>
        ...
        <nav aria-label="Page navigation m-auto mt-5">
            <ul class="pagination mt-5">
                ...
                <li class="page-item"><a class="page-link btn-divergentes"
                                         href="https://www.divergentes.com/fact-checking-como-verificamos-las-noticias/">Metodología</a></li>
