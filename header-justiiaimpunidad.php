...
<body <?php body_class(); ?>>
    <?php wp_body_open(); ?>
    <header class="eta fixed-top bg-header" id="header">
        <div class="container">
            <div class="row flex-nowrap justify-content-between align-items-center py-4 nav-top">
                ...
                <div class="col-sm-7 col-md-4 logo text-center">
                    <a class="" href="<?php echo get_site_url(); ?>">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="Logo" width="175" class="d-inline-block align-top" alt="Divergentes">
                    </a>
                </div>
