...
<footer>
    <div class="container">
        <p>©️ TODOS LOS DERECHOS RESERVADOS. MANAGUA, NICARAGUA. JUNIO 2020. Esta publicación puede ser utilizada, total o parcialmente, con previa autorización de la dirección del medio, se deben respetar los créditos de producción y adjuntar un enlace
...
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.resizeimagetoparent.min.js"></script>

<script>
	$(document).ready(function(){
		$("#myToast").toast('show');
	});
	var sectionFirst = new vidbg('#ejercitos-vidbg', {
		mp4: '/wp-content/themes/divergentes/img/ejercitos/FONDO.mp4',
		//poster: '/wp-content/themes/divergentes/img/ejercitos/covid_top-80.jpg',
	})
